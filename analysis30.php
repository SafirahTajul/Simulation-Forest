...
$q = "SELECT DBH, SpeciesGroup FROM newforest WHERE Status='Keep'";
...
$growth_rates = [
    1 => 0.6, // Example growth rate for SpeciesGroup 1
    2 => 0.6, // Example growth rate for SpeciesGroup 2
    3 => 0.5, // Example growth rate for SpeciesGroup 3
    5 => 0.5  // Example growth rate for SpeciesGroup 5
];
...
while ($row = mysqli_fetch_assoc($r)) {
    ...
    if (is_numeric($dbh)) {
        ...
        $dbh_30 = round($dbh_30); // Ensure the value is rounded to the nearest integer

        if (is_numeric($dbh_30)) {
            $projected_diameters[] = (int)$dbh_30; // Convert to integer
        }
    }
}

$diameter_counts = array_count_values($projected_diameters);
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                <h2>Tree Diameter Distribution - Year 30</h2>
                <p>Distribution of tree diameters (45, 50, 55, 60) for Year 30.</p>
            </div>
            ...
            <script>
                ...
                const layout = {
                    title: 'Tree Diameter Distribution - Year 30',
