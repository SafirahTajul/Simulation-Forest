...
// Fetch all records from the newforest database with DBH of 55
$q = "SELECT Species AS SpeciesGroup, SUM(Volume) AS Volume, COUNT(*) AS Number, SUM(Production) AS Production, SUM(DamageCrown + DamageStem) AS Damage, AVG(DBH) AS AvgDBH FROM newforest WHERE DBH = 55 GROUP BY Species";
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                ...
                <p>Summary of forest stand characteristics for Year 30 (Diameter 55 only).</p>
            </div>
