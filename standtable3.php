...
$q = "SELECT Species AS SpeciesGroup, SUM(Volume) AS Volume, COUNT(*) AS Number, SUM(Production) AS Production, SUM(DamageCrown + DamageStem) AS Damage, AVG(DBH) AS AvgDBH FROM newforest GROUP BY Species";
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                ...
                <p>Summary of forest stand characteristics for Year 30.</p>
            </div>
