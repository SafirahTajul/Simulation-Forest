...
// Fetch counts for different statuses in Year 0
$q = "SELECT Status, COUNT(*) as count FROM newforest GROUP BY Status";
...
<head>
    ...
    <title>Tree Status Summary</title>
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                <h2>Tree Status Summary - Year 0</h2>
                <p>Summary of tree statuses (Cut, Keep, Victim) for Year 0.</p>
            </div>
            ...
            <script>
                ...
                const statuses = ['Cut', 'Keep', 'Victim'];
                const counts = <?php echo json_encode(array_values($status_counts)); ?>;
                ...
                const layout = {
                    title: 'Tree Status Summary - Year 0',
                    xaxis: { title: 'Status' },
