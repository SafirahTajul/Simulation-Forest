...
// Function to get list of victim trees
function getVictimTrees($dbc, $speciesGroups, $minDamageCrown) {
    $victimTrees = [];

    $query = "SELECT * FROM newforest 
              WHERE SpeciesGroup IN (" . implode(',', $speciesGroups) . ") 
              AND DamageCrown >= $minDamageCrown";
...
// Define species groups to check and minimum damage crown
$speciesGroupsToCheck = [1, 2, 3, 5];
$minDamageCrown = 50;

// Get victim trees
$victimTrees = getVictimTrees($dbc, $speciesGroupsToCheck, $minDamageCrown);
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                <h2>Victim List</h2>
                <p>List of trees that are considered victims based on damage crown and species group.</p>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php foreach ($victimTrees as $tree) : ?>
                                <tr>
