...
// Function to get data for the stand table
function getStandTableData($dbc) {
    $query = "SELECT SpeciesGroup,
                     SUM(CASE WHEN DBH >= 45 THEN Volume ELSE 0 END) AS Volume,
                     COUNT(CASE WHEN DBH >= 45 THEN 1 ELSE NULL END) AS Number,
                     SUM(CASE WHEN DBH >= 45 THEN Production ELSE 0 END) AS Production,
                     SUM(CASE WHEN DBH >= 45 THEN DamageCrown + DamageStem ELSE 0 END) AS Damage
              FROM newforest
              WHERE SpeciesGroup IN (1, 2, 3, 5)
...
// Get stand table data
$standTableData = getStandTableData($dbc);
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                <h2>Stand Table</h2>
                <p>Stand table showing the volume, number, production, and damage for different species groups.</p>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php foreach ($standTableData as $row) : ?>
                                <tr>
                                    <td><?php echo $row['SpeciesGroup']; ?></td>
